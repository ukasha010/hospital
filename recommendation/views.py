...
# Symptom dictionary and disease list (as in the old Flask app)
...
# Helper function (replicated from Flask app)
def helper(dis):
...
# Prediction function (from Flask)
...
#     return render(request , 'recommendation/Login&signup.html')
...
def predict(request):
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms" or not symptoms:
            ...
            return render(request, 'recommendation/index.html', {'message': message})
        else:
            ...
            # Filter out any unrecognized symptoms
            valid_symptoms = [symptom for symptom in symptoms if symptom in symptoms_dict]
            print(valid_symptoms)
            
            # If no valid symptoms were found, return an error message
            if not valid_symptoms:
                message = "None of the entered symptoms were recognized. Please check your input."
                return render(request, 'recommendation/index.html', {'message': message})
...
def developer(request):
    return render(request, 'recommendation/developer.html')

def blog(request):
    return render(request, 'recommendation/blog.html')
